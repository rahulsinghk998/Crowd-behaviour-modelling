...
def storeSimulationEnvironment():
...
def museumSimulationEnvironment():
    rect_bound = ((0, 0), 800, 800)
    rect   = [((100, 800-120), 600, 120),]#[(startPoint),length_x,width_y]-[(5/40 * 800, 800 - 6/40 * 800), 30/40*800, 6/40*800]
    circle = [((221.60, 526.56), 15.3),
              ((344.45, 522.35), 15.3),
              ((346.31, 363.97), 15.3),
              ((589.29, 507.34), 15.3),
              ((515.76, 477.39), 15.3),
              ((486.73, 368.44), 15.3),]              #(centre, radius)
    line   = [((221.6, 526.56), (344.45, 522.35), 5),
              ((344.45, 522.35), (346.31, 363.97), 5),
              ((589.29, 507.34), (515.76, 477.39), 5),
              ((515.76, 477.39), (486.73, 368.44), 5),
              ((208.86, 98.07), (230.92, 100.07), 5), #add semi-circle
              ((230.92, 100.07), (230.92, 0), 5),
              ((605.46, 96.55), (582.37, 94.54), 5),  #add semi-circle
              ((582.37, 94.54), (582.37, 0), 5), ]       #((x1,x2), (y1,y2), thickness)
